...
function SectionThirteen({ advanceState }) {
    ...
    <div className="flex h-screen">
      <div className="text-5xl h-screen md:text-4xl w-1/2 p-12 leading-none flex flex-col justify-between gap-y-4">
        <div>
          ...
          >
            or <span style={{ color: `${currentHoverColor}` }}>functional</span>
          </motion.span>
          <AnimatePresence>
            {currentSongObject && (
              <motion.div
        ...
        <div>
          ...
          >
            Albums have been arranged by geographical location.
          </motion.div>
        </div>
      </div>
                ...
                <div>
                  <motion.div
                    ...
                    onMouseEnter={() => {
                      ...
                      setCurrentSongObject(sortedLocationArray[index]);
                    }}
                    onMouseLeave={() => {
